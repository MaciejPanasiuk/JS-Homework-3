...
.sort((a,b)=>b.max_atmosphering_speed-a.max_atmosphering_speed)//we sort it, so we still retain access to the data here and know as a fact that under 0 is the fastest ship

//console.log('a');
// find the fastest starship you can afford having 8500000 credits
console.log(
  'Fastest ship I can get for up to 8500000 is: ',
    getFastestShipFor(1), 'buuut there is also this ', ShipCostUnknown[0].name,' with a top speed of ', ShipCostUnknown[0].max_atmosphering_speed,' but we dont know its cost'
);
